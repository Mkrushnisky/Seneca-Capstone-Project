...
<asp:Content ID="Content2" ContentPlaceHolderID="body1" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox CssClass="form-control" ID="SupplierNameTB" runat="server"></asp:TextBox>
                </div>
                <%-- Address --%>
                <div class="form-group">
            ...
            </div><%-- End of Supplier Basic Information --%>
            ...
            </div><%-- End of Sub-Category Add Section --%>
        </div>
        <div class="row">
            <div class="row">
                <h3>Contacts</h3>
        ...
        <div class="row" style="text-align:center">
            <asp:Button ID="UpdateButton" runat="server" CssClass="btn-primary btn-lg" Text="Save" OnClick="UpdateButton_Click"  />
        ...
        <div class="row col-md-5">
            ...
            <div id="ContactTB" class="row" visible="false" runat="server">
                ...
                <div class="row">
                    <asp:Button ID="CAddButton" runat="server" CssClass="btn-primary btn-sm" Text="Add" Visible="false" OnClick="CAddButton_Click"/>
                    <asp:Button ID="CUpdateButton" runat="server" CssClass="btn-primary btn-sm" Text="Update" Visible="false" OnClick="CUpdateButton_Click" />
